  ...
  head: () => ({
    meta: [
      { title: "About Us — Group One Realty | Delhi NCR Real Estate Experts" },
      {
        name: "description",
        content:
          "Learn about Group One Realty's mission to deliver transparent, RERA-compliant real estate services across Delhi NCR. 15+ years, 1000+ happy families.",
      },
      { property: "og:title", content: "About Group One Realty" },
      {
        property: "og:description",
        content: "Your trusted Delhi NCR real estate partner since 2010.",
      },
    ],
  }),
  component: AboutPage,
      ...
      <section className="bg-gradient-navy text-navy-foreground py-20">
        <div className="mx-auto max-w-7xl container-px">
          ...
          <p className="mt-5 text-white/80 max-w-2xl text-lg leading-relaxed">
            For over 15 years, Group One Realty has been the trusted bridge between premium
            properties and discerning buyers, sellers, investors and NRIs across the National
            Capital Region.
          </p>
        </div>
      </section>
          ...
          {[
            {
              icon: Target,
              t: "Our Mission",
              d: "To make Delhi NCR real estate transparent, accessible and rewarding for every family and investor we serve.",
            },
            {
              icon: Eye,
              t: "Our Vision",
              d: "To be the most trusted real estate consultancy in North India, known for integrity, expertise, and client-first service.",
            },
            {
              icon: Heart,
              t: "Our Promise",
              d: "Verified listings, transparent pricing, no hidden charges, and end-to-end support — every single time.",
            },
          ].map(({ icon: Icon, t, d }) => (
        ...
        <div className="mx-auto max-w-7xl container-px grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="mt-2 font-display text-4xl font-bold">
              A Decade of Trust, Thousands of Happy Homes
            </h2>
            <div className="mt-6 space-y-4 text-foreground/85 leading-relaxed">
              <p>
                Founded with a simple belief — that buying or selling property should be an
                empowering experience, not a stressful one — Group One Realty has grown into one of
                Delhi NCR's most respected real estate consultancies.
              </p>
              <p>
                Headquartered in Sector 86, Gurugram, our team of local market experts has
                facilitated transactions worth over ₹500 crore across Gurgaon, Noida, Greater Noida,
                Delhi, Ghaziabad and Faridabad.
              </p>
              <p>
                Whether it's a first-time buyer, an NRI investor, or a commercial portfolio
                expansion — every client receives the same dedication, transparency and personal
                attention that defines our brand.
              </p>
            </div>
          </div>
            ...
            {[
              {
                icon: ShieldCheck,
                t: "RERA Compliant",
                d: "Only legally registered, transparent projects.",
              },
              {
                icon: Users,
                t: "Local Experts",
                d: "On-ground knowledge of every NCR micro-market.",
              },
              {
                icon: Award,
                t: "Award-winning Service",
                d: "Consistently 5-star rated by clients & developers.",
              },
              {
                icon: TrendingUp,
                t: "Investment Insight",
                d: "Data-driven recommendations for max ROI.",
              },
            ].map(({ icon: Icon, t, d }) => (
        ...
        <div className="mx-auto max-w-5xl container-px">
          <div className="bg-gradient-navy text-navy-foreground rounded-3xl p-10 md:p-16 text-center shadow-luxury">
            <h2 className="font-display text-3xl md:text-5xl font-bold">
              Ready to work with the <span className="text-gradient-gold">Delhi NCR experts?</span>
            </h2>
            ...
            <div className="mt-8 flex flex-wrap gap-3 justify-center">
              <Button asChild variant="gold" size="xl">
                <a href="tel:9654440099">📞 Call +91 96544 40099</a>
              </Button>
