  ...
  head: () => ({
    meta: [
      { title: "Rent Flats & Homes in Delhi NCR — Furnished & Semi-Furnished | Group One Realty" },
      {
        name: "description",
        content:
          "Rent verified furnished and semi-furnished flats, builder floors and villas in Gurgaon, Noida, Greater Noida and Delhi. Quick possession, owner-direct, zero brokerage options.",
      },
      { property: "og:title", content: "Rent a Home in Delhi NCR — Group One Realty" },
      {
        property: "og:description",
        content: "Furnished and semi-furnished rentals across Gurgaon, Noida and Delhi NCR.",
      },
    ],
  }),
  component: () => (
    <PurposePage
      ...
      title={
        <>
          Rent a <span className="text-gradient-gold">Home You'll Love</span> in Delhi NCR
        </>
      }
