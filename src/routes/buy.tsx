  ...
  head: () => ({
    meta: [
      { title: "Buy Property in Delhi NCR — Flats, Villas & Plots | Group One Realty" },
      {
        name: "description",
        content:
          "Buy RERA-approved flats, builder floors, villas and plots across Gurgaon, Noida, Delhi NCR. Verified listings, transparent pricing, zero brokerage on select deals.",
      },
      { property: "og:title", content: "Buy Property in Delhi NCR — Group One Realty" },
      {
        property: "og:description",
        content:
          "Verified RERA-approved properties for sale across Gurgaon, Noida, Greater Noida & Delhi.",
      },
    ],
  }),
  component: () => (
    <PurposePage
      ...
      title={
        <>
          Buy Your <span className="text-gradient-gold">Dream Home</span> in Delhi NCR
        </>
      }
