...
export const Route = createFileRoute("/resale")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Buy resale flats, builder floors and villas in Gurgaon, Noida and Delhi NCR. Negotiated prices, ready-to-move-in homes, transparent paperwork and end-to-end support." },
      { property: "og:title", content: "Resale Properties in Delhi NCR — Group One Realty" },
      { property: "og:description", content: "Best resale deals on ready-to-move flats and homes across Delhi NCR." },
    ],
  }),
  component: () => (
    <PurposePage
      ...
      title={<>Smart <span className="text-gradient-gold">Resale Deals</span> Across Delhi NCR</>}
