...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Visit, call, or WhatsApp Group One Realty. Office: Sector 86, Gurugram. Phone: +91 96544 40099. Email: info@grouponerealty.in" },
      { property: "og:title", content: "Contact Group One Realty" },
      { property: "og:description", content: "Reach our Delhi NCR real estate experts — call, WhatsApp, or visit our Gurugram office." },
    ],
  }),
...
function ContactPage() {
  const cards = [
    { icon: Phone, t: "Call Us", v: "+91 96544 40099", href: "tel:9654440099", sub: "Mon–Sat, 9 AM – 8 PM" },
    { icon: MessageCircle, t: "WhatsApp", v: "+91 96544 40099", href: "https://wa.me/919654440099", sub: "Instant replies, 24×7" },
    { icon: Mail, t: "Email", v: "info@grouponerealty.in", href: "mailto:info@grouponerealty.in", sub: "Reply within 4 hours" },
  ];
  return (
    <div className="pt-24">
      <section className="bg-gradient-navy text-navy-foreground py-16">
        <div className="mx-auto max-w-7xl container-px">
          ...
          <h1 className="mt-2 font-display text-4xl md:text-6xl font-bold">Let's Find Your <span className="text-gradient-gold">Perfect Property</span></h1>
          <p className="mt-4 text-white/80 max-w-2xl text-lg">Talk to a Delhi NCR expert today. Free, no-obligation consultation.</p>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-7xl container-px grid md:grid-cols-3 gap-5">
          {cards.map(({ icon: Icon, t, v, href, sub }) => (
            <a key={t} href={href} target={href.startsWith("http") ? "_blank" : undefined} rel="noopener noreferrer"
              ...
              <div className="mt-1 font-display text-xl font-bold text-foreground group-hover:text-gold transition-colors">{v}</div>
      ...
      <section className="pb-20">
        <div className="mx-auto max-w-7xl container-px grid lg:grid-cols-2 gap-10">
          <div>
            ...
            <p className="text-muted-foreground mt-2">Fill the form and our property expert will reach out within 30 minutes.</p>
            ...
            <div className="mt-6 bg-card rounded-2xl p-7 border border-border shadow-card space-y-4">
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">Unit Number-4, Pyramid Urban Homes 2,<br />Sector 86, Gurugram, Haryana 122004</div>
                </div>
              </div>
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">Monday – Saturday: 9:00 AM – 8:00 PM<br />Sunday: By appointment</div>
                </div>
              </div>
            </div>
